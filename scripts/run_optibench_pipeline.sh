...
CONFIG="configs/optibench_14b.yaml"
TRAIN_FILE="data/train_data/OptiBench_Train_1000.jsonl"
TEST_FILE="data/benchmarks/OptiBench.jsonl"
OUT_DIR="outputs/optibench_14b"

mkdir -p "$OUT_DIR"

echo "=========================================="
echo " OptiBench Self-Evolution Pipeline (Qwen3-14B)"
...
if os.path.exists('$OUT_DIR/verified_traces.jsonl'):
    ...
    print(f'  Verified traces: {vt}/1000')
