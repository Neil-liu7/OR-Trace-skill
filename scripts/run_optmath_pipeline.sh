...
CONFIG="configs/optmath_14b.yaml"
TRAIN_FILE="data/train_data/OptMATH_Train_500.jsonl"
TEST_FILE="data/benchmarks/OptMATH_Bench_166.jsonl"
OUT_DIR="outputs/optmath_14b"

mkdir -p "$OUT_DIR"

echo "=========================================="
echo " OptMATH Self-Evolution Pipeline (Qwen3-14B)"
...
if os.path.exists('$OUT_DIR/verified_traces.jsonl'):
    ...
    print(f'  Verified traces: {vt}/500')
